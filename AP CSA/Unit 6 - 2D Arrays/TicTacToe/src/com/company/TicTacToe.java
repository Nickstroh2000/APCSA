...
public class TicTacToe
{
    ...
    public String toString()
    {
        ...
        output += " " + gameBoard[0][0] + " | " + gameBoard[0][1] + " | " + gameBoard[0][2] + " | " + gameBoard[0][3] + "\n" +
                "---------------\n" +
                " " + gameBoard[1][0] + " | " + gameBoard[1][1] + " | " + gameBoard[1][2] + " | " + gameBoard[1][3] + "\n" +
                "---------------\n" +
                " " + gameBoard[2][0] + " | " + gameBoard[2][1] + " | " + gameBoard[2][2] + " | " + gameBoard[2][3] + "\n" +
                "---------------\n" +
                " " + gameBoard[3][0] + " | " + gameBoard[3][1] + " | " + gameBoard[3][2] + " | " + gameBoard[3][3];
        return output;
    }
    ...
    {
        return ( checkRow(0) || checkRow(1) || checkRow(2) || checkRow(3));
    }

    public boolean checkAllColumns()
    {
        return ( checkColumn(0) || checkColumn(1) || checkColumn(2) || checkColumn(3));
    }
    ...
    {
        if ( !gameBoard[rowNum][0].equals(" ") && gameBoard[rowNum][0].equals( gameBoard[rowNum][1] ) && gameBoard[rowNum][0].equals( gameBoard[rowNum][2] ) && gameBoard[rowNum][0].equals( gameBoard[rowNum][3] ))
        {
            return true;
        }
        return false;
    ...
    {
        if ( !gameBoard[0][colNum].equals(" ") && gameBoard[0][colNum].equals( gameBoard[1][colNum] ) && gameBoard[0][colNum].equals( gameBoard[2][colNum] ) && gameBoard[0][colNum].equals( gameBoard[3][colNum] ))
        {
            return true;
        }
        return false;
    ...
    {
        if ( !gameBoard[0][0].equals(" ") && gameBoard[0][0].equals( gameBoard[1][1] ) && gameBoard[0][0].equals( gameBoard[2][2] ) && gameBoard[0][0].equals( gameBoard[3][3] ))
        {
            return true;
        }
        return false;
    ...
    {
        if ( !gameBoard[0][3].equals(" ") && gameBoard[0][3].equals( gameBoard[1][2] ) && gameBoard[0][3].equals( gameBoard[2][1] ) && gameBoard[0][3].equals( gameBoard[3][0] ))
        {
            return true;
        }
        return false;
